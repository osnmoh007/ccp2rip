...
function HowItWorks({ isDarkMode }) {
  ...
  return (
    <section id="howItWorks" className="mb-20">
      <h2 className={`text-4xl font-bold mb-8 ${isDarkMode ? 'text-white' : 'text-gray-800'}`}>{t('howItWorks.title')}</h2>
      <ol className={`list-decimal pl-6 ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
